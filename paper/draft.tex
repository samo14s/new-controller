...
change along the feed path---and shows the frozen-point complement of
the whole-pass story: all three controllers lift the open-loop floor
($0.039$\,mm worst) by roughly an order of magnitude across
$3600$--$7200$\,rpm ($\mu$-TDC $0.474$--$0.802$\,mm, the filtered
member $0.340$--$0.641$\,mm, the realizable member
$0.232$--$0.656$\,mm).  In the time domain at the reference condition
the open loop diverges within $0.089$\,s, while all three members
hold the response at $3$--$4\,\mu$m with peak actuation of
$16$--$25$\,V---far inside the $450$\,V authority.
...
model, Floquet $m = 120$, bisection to $5\,\mu$m).  The dotted line
marks the design speed.  Source: \texttt{lobes.npz}.}
\label{fig:lobes}
\end{figure}
...
\texttt{s1\_fresh.npz}, run logs), and corrections to earlier
