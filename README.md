...
| [`docs/09_SCHEDULED_DK.md`](docs/09_SCHEDULED_DK.md) | **مشروع الورقة التالية — الإطار البارامتري**: بوابة M0 وإغلاقها المقيس (M0e)، تشخيص فجوة الاستنساخ، المسار البديل الواعي بالمشغِّل وسجلّ جولاته، شهادة المسار الكامل بنظرية المكوث، والقراءة الحقيقية لـ μ |
