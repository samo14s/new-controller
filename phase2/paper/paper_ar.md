...
عند $\zeta \approx 0.003$ يبلغ نصف عرض النمط $10.5$ rad/s عند النمط الأول و$11.4$ عند
الثاني، بينما تباعد شبكة لوغاريتمية بـ400 نقطة عند أسوأ رأس هو $74.8$ و$147.9$ rad/s على
الترتيب — أوسع بـ**7 و13 ضعفًا**. فتسقط العيّنات **بجانب** الذروة لا عليها: عند
