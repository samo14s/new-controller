...
BOUNDS2 = dict(
    ...
    mu_tdc_ps=dict(kpd=(-1.5, 1.5), kdd=(-1.5, 1.5)),
    ...
    ps_ac_rfa=dict(log_q_pos=(13.0, 20.0), log_q_vel=(-4.0, 8.0),
                   ...
                   log_fr=(3.15, 3.65)),
    ps_ac_rfl=dict(log_q_pos=(13.0, 20.0), log_q_vel=(-4.0, 8.0),
                   log_r=(-12.0, -6.0), log_ratio=(6.0, 12.0),
                   a4_mult=(0.8, 2.0),
                   log_depth=(-1.7, -0.5), q_notch=(0.7, 2.5),
                   log_fr=(3.15, 3.65),
                   log_f_lead=(2.6, 3.25), k_lead=(1.5, 9.0)),
...
BOUNDS2['ps_ac_rfa_l3'] = BOUNDS2['ps_ac_rfa']
